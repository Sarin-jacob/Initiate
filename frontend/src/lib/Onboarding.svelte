                            ...
                            <div class="form-control">
                                ...
                                {#if field.type === 'secret'}
                                    <div class="relative w-full">
                                        ...
                                        <button 
                                            type="button" 
                                            class="absolute top-1/2 right-3 -translate-y-1/2 opacity-60 hover:opacity-100 transition-opacity focus:outline-none"
                                            on:click={() => formFields[i].showPassword = !formFields[i].showPassword}
                                            title={field.showPassword ? "Hide password" : "Show password"}
                                        >
                                    ...
                                    <div class="relative w-full">
                                        <input 
                                            type={field.showPassword ? "text" : "password"} 
                                            bind:value={field.confirmValue} 
                                            required 
                                            class="input input-bordered input-primary w-full pr-12" 
                                            placeholder="Confirm {field.name.replace(/_/g, ' ')}" 
                                        />
                                    </div>
